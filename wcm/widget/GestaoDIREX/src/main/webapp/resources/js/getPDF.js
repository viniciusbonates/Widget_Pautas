...
function updatePDF(){
    ...
    if(state == 8 || state == 10){
        ...
        if(state == 8){
            ...
            c3 = DatasetFactory.createConstraint("hdn_aprvAssr", 19 , 19,  ConstraintType.MUST, true); 
            ...
            cStts = DatasetFactory.createConstraint("hdn_aprvAssr", 19, 19,  ConstraintType.MUST, true); 
